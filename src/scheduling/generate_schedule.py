...
def _generate_schedule_info(
    ...
    lp_instance = solve_lp(lp_instance)             # This function call pulp.solve function
    
    _, jobs = extract_info_schedule(lp_instance)    # This function process the output of the solve function
